...
class API_EXPORT QtVariantProperty : public QtProperty
{
public:
    ~QtVariantProperty();
...
class API_EXPORT QtVariantPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class API_EXPORT QtVariantEditorFactory : public QtAbstractEditorFactory<QtVariantPropertyManager>
{
    Q_OBJECT
public:
