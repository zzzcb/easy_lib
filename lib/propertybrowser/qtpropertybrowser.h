...
class API_EXPORT QtAbstractPropertyManager : public QObject
{
    Q_OBJECT
public:
...
class API_EXPORT QtAbstractEditorFactoryBase : public QObject
{
    Q_OBJECT
public:
...
class API_EXPORT QtBrowserItem
{
public:
...
class API_EXPORT QtAbstractPropertyBrowser : public QWidget
{
    Q_OBJECT
public:
