...
class API_EXPORT QtTreePropertyBrowser : public QtAbstractPropertyBrowser
{
    Q_OBJECT
...
public:
	...
	void setHeaderLabels(const QStringList &labels); ///< LinxCG add
	void setContextMenu(QAction *action);            ///< LinxCG add
	void clearContextMenu(void);                     ///< LinxCG add
	QModelIndex currentIndex() const;                ///< LinxCG add
